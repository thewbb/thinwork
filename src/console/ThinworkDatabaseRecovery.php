 ...
 * @property Di $di
 */
class ThinworkDatabaseRecovery extends Command {
    ...
    function __construct($di) {
        ...
        parent::__construct("thinwork:database:recovery");
    }
    ...
    protected function configure()
    {
        $this
            ...
            ->setDescription('recovery all tables from json file.')

            // the full command description shown when running the command with
            // the "--help" option
            ->setHelp('recovery all tables from json file, change table schema to new version.')

            ->addArgument('checkColumnChanged', InputArgument::OPTIONAL, 'check column changed, default not check.')
        ;
    }

    protected function execute(InputInterface $input, OutputInterface $output)
    {
        $checkColumnChanged = $input->getArgument('checkColumnChanged') == "true"? true: false;
